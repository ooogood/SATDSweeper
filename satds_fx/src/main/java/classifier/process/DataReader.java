...
public class DataReader {
	...
	public static List<Document> readComments(List<Comment> data) {

		List<Document> comments = new ArrayList<Document>();

		for (Comment cm : data) {
			Document dc = new Document(cm.getContent());
			dc.setLabel("WITHOUT_CLASSIFICATION");
			comments.add(dc);
		}
